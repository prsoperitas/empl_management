	...
	function buildCalendar() {// 현재 달fur
		...
		for (i = 1; i <= lastDate.getDate(); i++) {
			...
			if (resultObj[keydate] == 'nor') {
				// 정상출근 : 녹색 
				str = "<div style=' height:55px;  width:55px; background-color: #5dffa6; display: table-cell; vertical-align: middle;'>"
						+ i + "</div>";
			} else if (resultObj[keydate] == 'late') {
				// 지각 : 노란색 
				str = "<div style=' height:55px;  width:55px; background-color: #f6ff97; display: table-cell; vertical-align: middle;'>"
						+ i + "</div>";
			} else if (resultObj[keydate] == 'abse') {
				// 결근 : 빨간색 
				str = "<div style=' height:55px;  width:55px; background-color: #ff9292; display: table-cell; vertical-align: middle;'>"
						+ i + "</div>";
			} else if (resultObj[keydate] == 'va') {
				// 휴가 : 파랑색  
				str = "<div style=' height:55px;  width:55px; background-color: #81ffe6; display: table-cell; vertical-align: middle;'>"
						+ i + "</div>";
